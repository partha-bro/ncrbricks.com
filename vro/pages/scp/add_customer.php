...
<div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><b>Add Customer Details</b></h4>
                  <form class="forms-sample" role="form" method="post" action="add_customer.php">
...
<?php
	...
	{ 
		...
		$sql = "INSERT INTO customer (name, address, m_no, legal_name, GST_no, optional)
