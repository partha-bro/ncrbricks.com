<?php
	...
	$id = $_GET['id'];
		$result = mysqli_query($dbcon,"SELECT * FROM manufacture WHERE id='".$id."'")
	...
	if(isset($_POST['submit']))  
	{
		...
		$update_data="update `manufacture` set `name`= '".$new_name."',`address`= '".$new_address."',`m_no`='".$new_m_no."',`legal_name`= '".$new_legal_name."',`GST_no`= '".$new_gst_no."', `optional`= '".$new_optional."' where id='".$id."'";  
...
<div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"><b>Edit Manufacture Details</b></h4>
